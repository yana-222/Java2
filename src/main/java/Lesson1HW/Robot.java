...
public class Robot implements Actions{
    ...
    public Robot(String name, int maxRan, int maxHeight) {
        Name = name;
        MaxRan = maxRan;
        MaxHeight = maxHeight;
    }
    ...
    public void run(int length) {
        System.out.println(Name + " robot has run "+ length + " metres");
    }

    @Override
    public void jump(int height) {
        System.out.println(Name + " robot has jumped on " + height + " meters height");
    }
