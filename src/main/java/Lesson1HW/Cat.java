...
public class Cat implements Actions{
    ...
    public Cat(String name, int maxRan, int maxHeight) {
        Name = name;
        MaxRan = maxRan;
        MaxHeight = maxHeight;
    }
    ...
    public void run(int length) {
        System.out.println(Name + " cat has run " + length + " metres");
    }

    @Override
    public void jump(int height) {
        System.out.println(Name + " cat has jumped on " + height + " meters height");
    }
